...
*/		
	...
	if ( $image_url ) :
		...
		<header class="content-header-image">
			<div class="parallax <?php echo $image_class; ?>" style="background-image: url('<?php echo $image_url; ?>')">
				<div class="contenido_parallax">
					...
					<a href="<?php echo esc_url( home_url( '/' ) );  ?>"><img class="img_logo" title="perkins" src="<?php echo esc_url( home_url( '/' ) );  ?>/wp-content/uploads/2021/03/logo_trans2.png"/></a>
